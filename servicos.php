...
<body>
    ...
    <?php include "navbar.php";?>
	 ...
	 <center><img src="img/serviços.png" class="img-fluid mt-4"></center></div>
	   <center> <div class="col-12 col-lg-9">
				<div class="card-deck text-center mt-5">
				<div class="card mb-5">
					<img src="img/cursoos.png" class="card-img-top img-fluid">
					<div class="card-body">
						<h4 class="card-title">Cursos</h4>
						<h6 class="card-subtitle mb-2 text-muted">Encontre a sua area e aprenda</h6>
					</div>
					<button class="button_busca card-footer" type="button" onclick="location.href='cursos.php'">Entre Aqui</button>
				</div>
				<div class="card mb-5">
			...
			<div class="card mb-5">
			  ...
			  <div class="col-12 col-lg-9">
				...
				<div class="card mb-5">
					<img src="img/manutenção.png" class="card-img-top img-fluid">
					<div class="card-body">
			...
			<div class="card mb-5">
					<img src="img/eletricista.png" class="card-img-top img-fluid">
					<div class="card-body">
			...
			<div class="card mb-5">
					<img src="img/eventos.png" class="card-img-top img-fluid">
					<div class="card-body">
			...
			<div class="card mb-5">
					<img src="img/pintor.png" class="card-img-top img-fluid">
					<div class="card-body">
  ...
  <div class="col-12 col-lg-9">
                 ...
                 <div class="card-deck text-center">
			<div class="card mb-5">
					<img src="img/musical.png" class="card-img-top img-fluid">
					<div class="card-body">
			...
			<div class="card mb-5">
					<img src="img/artes.png" class="card-img-top img-fluid">
					<div class="card-body">
			...
			<div class="card mb-5">
					<img src="img/informatica.png" class="card-img-top img-fluid">
					<div class="card-body">
			...
			<div class="card mb-5">
					<img src="img/linpeza.png" class="card-img-top img-fluid">
					<div class="card-body">
